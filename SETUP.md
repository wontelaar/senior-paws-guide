...
## 9. 추후 검토 항목 (지금 당장은 아님)

- **Pinterest 자동 포스팅**: 새 글이 발행될 때마다 자동으로 핀을 올리는 자동화.
  반려동물/라이프스타일 콘텐츠가 핀터레스트에서 특히 잘 먹히고, 백링크/트래픽
  확보에 도움이 될 수 있음. 사람이 직접 홍보하러 다니는 게 아니라 또 하나의
  자동화 파이프라인이라 지금 방향성(손 안 대기)과도 맞음. 사이트가 좀 더
  자리 잡은 뒤 진행하기로 함.
