...
3. For each new draft:
   - Read the full content and check it against the established rubric: no fabricated first-person experience, accurate product claims, appropriate health/safety hedging, no leaked internal jargon (e.g. "ASIN") or placeholder text.
...
6. If anything fails QA, has a broken/dead link, or has a content issue, fix it (or flag it clearly) before approving.
